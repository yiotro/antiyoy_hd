...
import yio.tro.onliyoy.stuff.scroll_engine.SegmentYio;
...
public class TabsEngineYio {
    ...
    private void applyNearbyMagnetsPower() {
        ...
        if (ignoreFactor.getValue() > 0) return;
    ...
    public void swipeTab(float direction) {
        ...
        ignoreFactor.destroy(MovementType.lighty, Math.min(5, Math.abs(10 / direction)));
