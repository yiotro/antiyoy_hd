...
public class ProcessCompletionCheck extends AbstractLoadingProcess{

    public ProcessCompletionCheck(LoadingManager loadingManager) {
    ...
    @Override
    public void prepare() {
        initGameMode(GameMode.completion_check);
